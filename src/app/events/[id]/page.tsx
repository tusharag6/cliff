  ...
  return (
    <div className="container">
      ...
      <div className="flex flex-col justify-center content-center gap-1">
        <h4 className="text-2xl font-bold tracking-tight pt-3">Description</h4>
        <p className="font-medium hidden md:block">
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quae magnam
          facere quos rerum delectus! Possimus architecto, eos odio consectetur
          voluptate doloremque fuga quibusdam incidunt earum illum, atque fugiat
          quia officia.
        </p>
      </div>
      <div className="">
      ...
      <div className="flex flex-col justify-center content-center gap-4">
        <h4 className="text-2xl font-bold tracking-tight pt-3">Organizer</h4>
